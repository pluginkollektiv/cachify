...
<p>
	<a href="<?php echo esc_url( __( 'https://cachify.pluginkollektiv.org/documentation/faq/', 'cachify' ), array( 'https' ) ); ?>" rel="noopener noreferrer"><?php esc_html_e( 'FAQ', 'cachify' ); ?></a>
