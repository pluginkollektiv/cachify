						...
						<td>
							<fieldset>
								<label for="cachify_without_ids">
									<textarea name="cachify[without_ids]" id="cachify_without_ids" rows="1"><?php echo esc_attr($options['without_ids']) ?></textarea>
								...
								<label for="cachify_without_agents">
									<textarea name="cachify[without_agents]" id="cachify_without_agents" rows="1"><?php echo esc_attr($options['without_agents']) ?></textarea>
